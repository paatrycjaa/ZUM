...
#delete NA column
df_drink = df_drink[ , ! apply( df_drink , 2 , function(x) all(is.na(x)) ) ]
df_drink_test = df_drink_test[ , ! apply( df_drink_test , 2 , function(x) all(is.na(x)) ) ]
#check if any NA
